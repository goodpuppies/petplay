...
new PostMan(state, {
    ...
    GETCOMPOSITORPTR: (_payload): bigint | null => {
...
function initializeOpenVR() {
    ...
    const compositorPtr = OpenVR.VR_GetGenericInterface(stringToPointer(OpenVR.IVRCompositor_Version), initErrorPtr);
    ...
    state.compositorPTR = interfaceErrorComp === OpenVR.InitError.VRInitError_None ? compositorPtr : null;
