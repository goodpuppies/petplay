...
export class ScreenCapture {
    ...
    private FIXED_SIZE = 8294400; // 8.3 MB buffer
...
`, "screen_capture.py");
    ...
    private stringToBinary(str: string): Uint8Array {
        ...
        decode(0, this.FIXED_SIZE);
        return wasmMemory.subarray(0, this.FIXED_SIZE);
    }
    ...
    private updateFrame() {
        ...
        this.currentFrame = this.stringToBinary(encodedData);
    }
    ...
    public getCurrentFrame(): { pixels: Uint8Array, width: number, height: number } {
        return {
            pixels: this.currentFrame || new Uint8Array(0),
            width: this.width,
            height: this.height
        };
    }
